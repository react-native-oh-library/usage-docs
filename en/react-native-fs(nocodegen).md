...
Find the matching version information in the release address of a third-party library and download an applicable .tgz package: [@react-native-oh-library/react-native-fs Releases](https://github.com/react-native-oh-library/react-native-fs/releases).
...
### 3. Configuring CMakeLists and Introducing FsPackge
...
+ add_subdirectory("${OH_MODULE}/@react-native-oh-tpl//react-native-fs/src/main/cpp" ./fs)
...
### 4. Introducing FsPackage to ArkTS
