...
|  disabled    | Content of the header   | boolean | Yes      | All      | Yes               |
|  color    | Custom color for the text   | string | Yes      | All      | Yes               |
|  mode     | Mode of the Appbar.   | small \| medium \| large \| center-aligned | Yes      | All      | Yes               |
...
|  mode  | Whether the color is a dark color. A dark button will render light text and vice-versa. Only applicable for  | boolean | Yes      | All      | Yes               |
...
|  onPress  | Function to execute on press.  | (e: GestureResponderEvent) => void  | Yes      | All      | Yes               |
|  textStyle  | Text content style of the DataTableTitle.  | Type: StyleProp<TextStyle>  | Yes      | All      | Yes               |
...
|  onDismiss    | Callback called when Menu is dismissed.  |  () => void | Yes      | All      | Yes               |
...
|  Name   | Description |      Type       | Required | Platform | HarmonyOS Support |
| :-----: | :---------: | :-------------: | -------- | -------- | ----------------- |
|  mode    | Mode of the TextInput. |  flat \| outlined | Yes      | All      | 
...
|  onPress    | Function to execute on press. |   (value?: GestureResponderEvent | string) => void | Yes      | All      |  Yes      |
