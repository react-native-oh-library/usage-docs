...
Find the matching version information in the release address of a third-party library and download an applicable .tgz package: [@react-native-oh-tpl/react-native-picker Releases](https://github.com/react-native-oh-library/react-native-picker/releases).
...
```bash
npm install @react-native-oh-tpl/react-native-picker@file:#
```

#### **yarn**

```bash
yarn add @react-native-oh-tpl/react-native-picker@file:#
```
