...
```bash
npm install @react-native-oh-tpl/react-native-mlkit-ocr@file:#
```

#### **yarn**

```bash
yarn add @react-native-oh-tpl/react-native-mlkit-ocr@file:#
```
...
### 配置 CMakeLists 和引入 RNMlkitOcrPackage
